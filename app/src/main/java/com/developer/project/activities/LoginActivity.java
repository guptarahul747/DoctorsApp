...
import com.developer.project.parse.SyUser;

public class LoginActivity extends _Activity {
	...
	class CallWebService extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (isLoggedIn) {
				...
				intent.putExtra(TeacherHomeActivity.TAG_ACCOUNT_TYPE, ApplicationStart.getAccountType());
