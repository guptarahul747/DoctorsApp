package com.developer.project.parse;
...
import com.developer.project.app.ApplicationStart;
import com.developer.project.net.UserApi;
		...
		try {
			...
			if (nodeList.getLength() > 0) {
				for (int iNode = 0; iNode < nodeList.getLength(); iNode++) {
					...
					if (SyUtil.GetElementNode(fstElmnt, "username") != null) {
						ApplicationStart.setUserName(SyUtil.GetElementNode(fstElmnt, "username"));
					}
					
					if (SyUtil.GetElementNode(fstElmnt, "AccountType") != null) {
						ApplicationStart.setAccountType(SyUtil.GetElementNode(fstElmnt, "AccountType"));
					}
